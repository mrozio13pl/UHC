## defaults
scoreboard players set UHC$settings uhc_border 1000
...
scoreboard players set UHC$settings uhc_saturation 1
scoreboard players set UHC$settings uhc_resistance 1

scoreboard players set UHC$settings uhc_food 0
scoreboard players set UHC$settings uhc_gap 0
scoreboard players set UHC$settings uhc_tools 0
scoreboard players set UHC$settings uhc_axe 1
scoreboard players set UHC$settings uhc_iron 0
...
## defaults
# finish
scoreboard players set UHC$settings uhc_defaults 1